...
import { UserOutlined, DesktopOutlined, ClockCircleOutlined, RocketOutlined, CaretRightOutlined } from '@ant-design/icons';
            ...
            <Carousel autoplay>
                        ...
                        <div>
                            <h3 style={contentStyle}>
                                <img style={{ width: '100%' }} src='https://cdn.akamai.steamstatic.com/steam/apps/1966720/header.jpg?t=1700231592' />
                            </h3>
                        </div>
                        <div>
                            <h3 style={contentStyle}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <div className='statistic'>
                    <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around', alignItems: 'center' }}>
                        <Statistic title="Total Game" value={'369'} prefix={<DesktopOutlined style={{ padding: '5px', backgroundColor: '#191b20', borderRadius: '10px' }} />} />
                        <Statistic title="Performance" value={'High'} prefix={<RocketOutlined style={{ padding: '5px', backgroundColor: '#191b20', borderRadius: '10px' }} />} />
                        ...
                        <Statistic title="Online" value={1496} prefix={<UserOutlined style={{ padding: '5px', backgroundColor: '#191b20', borderRadius: '10px' }} />} />
