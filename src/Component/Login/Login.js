        ...
        <div >
            ...
            <div className='card-container'
                ...
                <Card style={{ minWidth: 390, backgroundColor: '#121212', border: '0', borderRadius: '3%' }}>
                    <div style={{ display: "flex", justifyContent: "center" }}>
                        <h1 style={{ color: '#bdbdbd', fontSize: 40 }}>Login</h1>
                    </div>
                    <Form
                        name="normal_login"
                    ...
                    >
                        ...
                        <a
                            style={{ float: "right", fontWeight: 'bold', color: '#bdbdbb' }}
           ...
           Sign up
                            ...
                            <Col>
                                ...
                                <Row span={12}>
                                    <Button htmlType="button" style={{ marginTop: 10, fontWeight: 'bold', textDecoration: 'none', display: 'flex', justifyContent: 'left', justifyContent: 'center' }} onClick={() => history.push("/signup")}>
                                        Sign up
                                    </Button>
                                </Row>
                            </Col>
