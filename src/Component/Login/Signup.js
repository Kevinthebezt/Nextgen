    ...
    return (
        <div >
            ...
            <div className='card-container'
                ...
                <Card style={{ minWidth: 390, backgroundColor: '#121212', border: '0', borderRadius: '3%' }}>
                    <div style={{ display: "flex", justifyContent: "center" }}>
                        <h1 style={{ color: '#bdbdbd', fontSize: 40 }}>Signup</h1>
                    </div>
                    <Form
                        name="normal_login"
                        ...
                        >
                         ...
                         Back
                            ...
                            <Col>
                                ...
                                {/* <Row span={8}>
                                        <p style={{ marginTop: 10, color: '#bdbdbd', textDecoration: 'none', display: 'flex', justifyContent: 'center' }}>|</p>
                                    </Row> */}
                                <Row span={12}>
                                    {/* <a type="primary" style={{ marginTop: 10, color: '#bdbdbd', fontWeight: 'bold', textDecoration: 'none', display: 'flex', justifyContent: 'left' }} onClick={() => history.push("/signup")}>
                                        Sign up
                                    </a> */}
                                    <Button htmlType="button" style={{ marginTop: 10, fontWeight: 'bold', textDecoration: 'none', display: 'flex', justifyContent: 'left', justifyContent: 'center' }} onClick={() => history.push("/login")}>
                                        Login
                                    </Button>
                                </Row>
                            </Col>
