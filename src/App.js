...
function App() {
  ...
  return (
    <Router>
      <div className="App">
        <div className="Container" style={{padding: '0 9%'}} >
          ...
          <Switch>
            ...
            <Route path="/aboutus" exact component={() => <About notification={notification} user={user} />} ></Route>
            ...
            <Route path="/checkout" exact component={() => <Checkout notification={notification} user={user} />} ></Route>
          </Switch>


        </div>
        <Footer notification={notification} user={user} />
